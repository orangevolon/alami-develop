...
const UxSkill = () => {
  ...
  const skillElement = Skill({
    ...
    title: "UI/UX",
    description: `Even though, I’m not a UI/UX designer now, I have a robust understanding of the user experience concepts, from color psychology to the methodologies of the user research. I’ve also mastered several design tools including Sketch, Xd, Illustrator and Photoshop over the course of the last decade.`
  });
